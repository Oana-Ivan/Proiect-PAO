...
public class Audit {
    ...
    public static void scriereFisier(int optiuneAleasa) {
        ...
        switch (optiuneAleasa) {
            ...
            case 16: {
                s = "stergere bibliotecari dupa nume";
                break;
            }
            case 17: {
                s = "marire salariu bibliotecari";
                break;
            }
            case 18: {
                s = "marire pret abonamente";
                break;
            }
        }
        ...
        try {
            Files.write(Paths.get("audit.csv"), (s + "," + dateFormat.format(date) + ", " + Thread.currentThread().getName() + "\n").getBytes(), StandardOpenOption.APPEND);
        }catch (IOException e) {
        }
    }
}